...
from AltBots.data import NAKSH
...
API_ID = 22152362
API_HASH = "2df0bf931cc4a8516b43e61263e701b7”
...
SUDO_USERS = list(map(lambda x: int(x), getenv("SUDO_USERS",default = "7043794748")))
for x in OXYGEN:
    SUDO_USERS.append(x)
OWNER_ID = int(getenv("OWNER_ID",default = "7043794748")
